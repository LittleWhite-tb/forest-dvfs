...
/**
  @file Predictive.h
  @brief The Predictive class header is in this file 
 */
#ifndef H_PREDICTIVE
#define H_PREDICTIVE
...
/**
 * @class Predictive
 * @brief Predictive algorithm to give the action to do depending on the boundness of the program
 */
class Predictive:public Decision
{
	public:
		/**
		 * @brief Constructor
