...
/**
  @file Config.h
  @brief The Config class header is in this file
 */
#ifndef H_CONFIG
#define H_CONFIG
...
class Config
{
   public:
      ...
      /**
       * @brief Returns true if the fork option is set in the configuration file.
       *
       * @return True if the profiler is expected to fork.
       */
      inline bool profFork () const
      {
         return this->pfork;
      }
   ...
   private:
      ...
      /**
       * @brief Does the profilers have to fork?
       */
      bool pfork;
