...
#$UTIL_DIR/timing.sh $k $NUMCORES Naive

echo "Running experiment using REST-Profiler-Predictive setting at $k ms intervals"
...
#$UTIL_DIR/timing.sh $k $NUMCORES Predictive
