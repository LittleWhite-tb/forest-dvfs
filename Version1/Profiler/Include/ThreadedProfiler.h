...
/**< @struct pointer table which is passed to the profiler to tell it who to initialize, report to, and destroy*/
...
/**< @struct a context with all necessary information for PAPI implmentation and threading*/
