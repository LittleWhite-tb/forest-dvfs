...
void
perfmon_logDerivedMetricsNehalem(PerfmonGroup group, double time,double timeStamp)
{
    int threadId;
    double inverseClock = 1.0 /(double) timer_getCpuClock();
...
static PerfmonGroupHelp nehalem_group_help[NUM_GROUPS_NEHALEM] = {
