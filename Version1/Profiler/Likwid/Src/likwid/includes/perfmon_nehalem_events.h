...
#define NUM_ARCH_EVENTS_NEHALEM 494
...
, {"UOPS_EXECUTED_CORE_ACTIVE_CYCLES_NO_PORT5",
  "PMC", 
   0xB1,0x1F,0x61,0x00}
, {"UOPS_EXECUTED_CORE_STALL_CYCLES_NO_PORT5",
  "PMC", 
   0xB1,0x1F,0xC1,0x01}
, {"UOPS_EXECUTED_CORE_STALL_COUNT_NO_PORT5",
  "PMC", 
   0xB1,0x1F,0xC5,0x01}
, {"UOPS_EXECUTED_PORT5",
  "PMC", 
...
, {"UOPS_EXECUTED_CORE_STALL_CYCLES",
  "PMC", 
   0xB1,0x3F,0xC1,0x01}
, {"UOPS_EXECUTED_CORE_STALL_COUNT",
  "PMC", 
   0xB1,0x3F,0xC5,0x01}
