...
#define NUM_ARCH_EVENTS_K10 328
...
, {"L3_EVICTS_MODIFY",
  "PMC", 
   0x4E3,0x08,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_0",
  "PMC", 
   0x1E0,0x01,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_1",
  "PMC", 
   0x1E0,0x02,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_2",
  "PMC", 
   0x1E0,0x04,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_3",
  "PMC", 
   0x1E0,0x08,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_4",
  "PMC", 
   0x1E0,0x10,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_5",
  "PMC", 
   0x1E0,0x20,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_6",
  "PMC", 
   0x1E0,0x40,0,0}
, {"CPU_TO_DRAM_LOCAL_TO_7",
  "PMC", 
   0x1E0,0x80,0,0}
, {"IO_TO_DRAM_LOCAL_TO_0",
  "PMC", 
   0x1E1,0x01,0,0}
, {"IO_TO_DRAM_LOCAL_TO_1",
  "PMC", 
   0x1E1,0x02,0,0}
, {"IO_TO_DRAM_LOCAL_TO_2",
  "PMC", 
   0x1E1,0x04,0,0}
, {"IO_TO_DRAM_LOCAL_TO_3",
  "PMC", 
   0x1E1,0x08,0,0}
, {"IO_TO_DRAM_LOCAL_TO_4",
  "PMC", 
   0x1E1,0x10,0,0}
, {"IO_TO_DRAM_LOCAL_TO_5",
  "PMC", 
   0x1E1,0x20,0,0}
, {"IO_TO_DRAM_LOCAL_TO_6",
  "PMC", 
   0x1E1,0x40,0,0}
, {"IO_TO_DRAM_LOCAL_TO_7",
  "PMC", 
   0x1E1,0x80,0,0}
, {"CPU_READ_COMMAND_LATENCY_READ_BLOCK",
  "PMC", 
   0x1E2,0x01,0,0}
, {"CPU_READ_COMMAND_LATENCY_READ_BLOCK_SHARED",
  "PMC", 
   0x1E2,0x02,0,0}
, {"CPU_READ_COMMAND_LATENCY_READ_BLOCK_MODIFIED",
  "PMC", 
   0x1E2,0x04,0,0}
, {"CPU_READ_COMMAND_LATENCY_CHANGE_TO_DIRTY",
  "PMC", 
   0x1E2,0x08,0,0}
, {"CPU_READ_COMMAND_LATENCY_LOCAL_TO_0",
  "PMC", 
   0x1E2,0x10,0,0}
, {"CPU_READ_COMMAND_LATENCY_LOCAL_TO_1",
  "PMC", 
   0x1E2,0x20,0,0}
, {"CPU_READ_COMMAND_LATENCY_LOCAL_TO_2",
  "PMC", 
   0x1E2,0x40,0,0}
, {"CPU_READ_COMMAND_LATENCY_LOCAL_TO_3",
  "PMC", 
   0x1E2,0x80,0,0}
, {"HYPERTRANSPORT_LINK0_COMMAND_DWORD_SENT",
  "PMC", 
   0xF6,0x01,0,0}
, {"HYPERTRANSPORT_LINK0_DATA_DWORD_SENT",
  "PMC", 
   0xF6,0x02,0,0}
, {"HYPERTRANSPORT_LINK0_BUFFER_DWORD_SENT",
  "PMC", 
   0xF6,0x04,0,0}
, {"HYPERTRANSPORT_LINK0_NOP_DWORD_SENT",
  "PMC", 
   0xF6,0x08,0,0}
, {"HYPERTRANSPORT_LINK0_ADDRESS_DWORD_SENT",
  "PMC", 
   0xF6,0x10,0,0}
, {"HYPERTRANSPORT_LINK0_PER_PACKET_CRC_SENT",
  "PMC", 
   0xF6,0x20,0,0}
, {"HYPERTRANSPORT_LINK0_SUBLINK_MASK",
  "PMC", 
   0xF6,0x80,0,0}
, {"HYPERTRANSPORT_LINK0_ALL_SENT",
  "PMC", 
   0xF6,0x37,0,0}
, {"HYPERTRANSPORT_LINK1_COMMAND_DWORD_SENT",
  "PMC", 
   0xF7,0x01,0,0}
, {"HYPERTRANSPORT_LINK1_DATA_DWORD_SENT",
  "PMC", 
   0xF7,0x02,0,0}
, {"HYPERTRANSPORT_LINK1_BUFFER_DWORD_SENT",
  "PMC", 
   0xF7,0x04,0,0}
, {"HYPERTRANSPORT_LINK1_NOP_DWORD_SENT",
  "PMC", 
   0xF7,0x08,0,0}
, {"HYPERTRANSPORT_LINK1_ADDRESS_DWORD_SENT",
  "PMC", 
   0xF7,0x10,0,0}
, {"HYPERTRANSPORT_LINK1_PER_PACKET_CRC_SENT",
  "PMC", 
   0xF7,0x20,0,0}
, {"HYPERTRANSPORT_LINK1_SUBLINK_MASK",
  "PMC", 
   0xF7,0x80,0,0}
, {"HYPERTRANSPORT_LINK1_ALL_SENT",
  "PMC", 
   0xF7,0x37,0,0}
, {"HYPERTRANSPORT_LINK2_COMMAND_DWORD_SENT",
  "PMC", 
   0xF8,0x01,0,0}
, {"HYPERTRANSPORT_LINK2_DATA_DWORD_SENT",
  "PMC", 
   0xF8,0x02,0,0}
, {"HYPERTRANSPORT_LINK2_BUFFER_DWORD_SENT",
  "PMC", 
   0xF8,0x04,0,0}
, {"HYPERTRANSPORT_LINK2_NOP_DWORD_SENT",
  "PMC", 
   0xF8,0x08,0,0}
, {"HYPERTRANSPORT_LINK2_ADDRESS_DWORD_SENT",
  "PMC", 
   0xF8,0x10,0,0}
, {"HYPERTRANSPORT_LINK2_PER_PACKET_CRC_SENT",
  "PMC", 
   0xF8,0x20,0,0}
, {"HYPERTRANSPORT_LINK2_SUBLINK_MASK",
  "PMC", 
   0xF8,0x80,0,0}
, {"HYPERTRANSPORT_LINK2_ALL_SENT",
  "PMC", 
   0xF8,0x37,0,0}
, {"HYPERTRANSPORT_LINK3_COMMAND_DWORD_SENT",
  "PMC", 
   0x1F9,0x01,0,0}
, {"HYPERTRANSPORT_LINK3_DATA_DWORD_SENT",
  "PMC", 
   0x1F9,0x02,0,0}
, {"HYPERTRANSPORT_LINK3_BUFFER_DWORD_SENT",
  "PMC", 
   0x1F9,0x04,0,0}
, {"HYPERTRANSPORT_LINK3_NOP_DWORD_SENT",
  "PMC", 
   0x1F9,0x08,0,0}
, {"HYPERTRANSPORT_LINK3_ADDRESS_DWORD_SENT",
  "PMC", 
   0x1F9,0x10,0,0}
, {"HYPERTRANSPORT_LINK3_PER_PACKET_CRC_SENT",
  "PMC", 
   0x1F9,0x20,0,0}
, {"HYPERTRANSPORT_LINK3_SUBLINK_MASK",
  "PMC", 
   0x1F9,0x80,0,0}
, {"HYPERTRANSPORT_LINK3_ALL_SENT",
  "PMC", 
   0x1F9,0x37,0,0}
};
